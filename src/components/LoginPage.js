                ...
                <div className="card-body">
                    <form className="loginForm" onSubmit={handleSubmit(onSubmit)}>
                        <div className="input-group form-group">
                            ...
                            <input type="text" name="username" className="form-control" placeholder="username" ref={register({required: true})} />
                        {errors.username && <span className="error">user name is required</span>}
                        </div>
                        <div className="input-group form-group">
                            <div className="input-group-prepend">
